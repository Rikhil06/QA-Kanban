...
export default function Page() {
  ...
  useEffect(() => {
    fetch(`https://qa-backend-105l.onrender.com /teams/${user?.teamId}/members`, {
      headers: {
  ...
  useEffect(() => {
    async function loadCode() {
      const res = await fetch(`https://qa-backend-105l.onrender.com /teams/${user?.teamId}/invite-link`, {
      ...
      <div className="max-w-6xl mx-auto px-6 py-12">
        ...
        <div className="flex items-center gap-6 text-sm text-white/50 border border-white/5 bg-white/[0.02] rounded-xl px-5 py-3">
            <div className="flex items-center gap-2">
                ...
                <span>
                <span className="text-white/80">{activeCount}</span> active members
                </span>
            </div>
            ...
            <div className="flex items-center gap-2">
                ...
                <span>
                <span className="text-white/80">{pendingCount}</span> pending invites
                </span>
            </div>
        </div>
