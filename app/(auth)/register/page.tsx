...
export default function RegisterPage() {
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    try{
      setIsLoading(true);
      const res = await fetch('https://qa-backend-105l.onrender.com /api/auth/register', {
        method: 'POST',
  ...
  return (
    ...
    <p className="text-white/40 text-xs text-center mt-6">
        ...
        and{' '}
        <Link href="/privacy-policy" className="text-white/60 hover:text-white/80 underline underline-offset-2 transition-colors">
          Privacy Policy
        </Link>
        .
      </p>
